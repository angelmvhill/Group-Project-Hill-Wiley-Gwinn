...
class MACD_Crossover(bt.Strategy):
    ...
    def __init__(self, macd1=12, macd2=26, macdsig=9, atrperiod=14, atrdist=3.0, smaperiod=30,dirperiod=10):
        ...
        params = {
            ...
            'macd2': macd2,
            'macdsig': macdsig,
            'atrperiod': atrperiod,  # ATR Period (standard)
            'atrdist': atrdist,  # ATR distance for stop price
            'smaperiod': smaperiod,  # SMA Period (pretty standard)
            'dirperiod': dirperiod  # Lookback period to consider SMA trend direction
        }
